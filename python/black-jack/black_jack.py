...
def higher_card(card_one: str, card_two: str) -> Union[Tuple[str, str], str]:
...
def value_of_ace(card_one: str, card_two: str):
    ...
    if value_card_one == 1 or value_card_two == 1:
        return 1
    elif value_card_two + value_card_one <= 10:
        return 11
    else:
        return 1
...
def is_blackjack(card_one: str, card_two: str) -> bool:
    ...
    3.  '2' - '10' = numerical value.
    """
    return any([card_one == "A" and value_of_card(card_two) == 10, card_two == "A" and value_of_card(card_one) == 10])
